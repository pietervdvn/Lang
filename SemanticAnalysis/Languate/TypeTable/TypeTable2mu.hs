...
explanationFSTT	:: MarkUp
explanationFSTT	= titling "How to read a 'Supertypetable of T a0 a1'" $
...
fstt2md	:: KindLookupTable -> TypeID -> FullSuperTypeTable -> MarkUp
fstt2md klt tid@(fqn, nm) fstt
	= let	nrOfArgs	= findWithDefault Kind tid klt & numberOfKindArgs
		...
		title		= Mu.Seq [b "Supertypes of ", code tpname]
